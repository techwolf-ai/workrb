"""Job Normalization ranking task using monolingual datasets from MELO (Retyk et al., 2024)."""
...
class MELORanking(RankingTask):
    """
    MELO: Job Normalization ranking task using monolingual datasets from MELO (Retyk et al., 2024).

    This task includes monolingual datasets from the MELO Benchmark, which involve Entity Linking
